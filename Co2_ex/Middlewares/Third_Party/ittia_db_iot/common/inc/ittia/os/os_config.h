...
/* RAMFS is enabled by default. */
#ifndef DB_EXCLUDE_RAMFS_FILE
#define HAVE_RAMFS_FILE
#endif

/* Define new file interfaces above this line. */

/* Example file interface is never enabled. */
#if 0
#define HAVE_EXAMPLE_FILE
#endif
...
/* #define DB_FILE_SNAPSHOT */
#if defined(DB_DEBUG) && (defined(OS_POSIX) || defined(OS_WIN32))
#   define DB_ENABLE_FAILURE
#endif
