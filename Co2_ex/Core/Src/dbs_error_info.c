...
static const dbs_error_info_t errors[] =
{
    ...
    {  -114, "DB_ECURSORMODE",                    "Invald or unsupported cursor mode" },
    ...
    {  -400, "DB_ESQLCODESIZETOOLARGE",           "Generated code exceeds maximum code size" },
    {  -401, "DB_ESQLTABLENOTEXISTS",             "Table does not exist" },
    {  -402, "DB_ESQLINVALIDCOLUMNNAME",          "Invalid column name" },
    {  -403, "DB_ESQLCOLUMNAMBIGUOUSLYDEFINED",   "Column ambiguously defined" },
    {  -404, "DB_ESQLINCOMPATIBLETYPES",          "Incompatible types" },
    {  -405, "DB_ESQLINVALIDFUNCTIONNAME",        "Invalid function name" },
    {  -406, "DB_ESQLINVALIDNUMBEROFARGUMENTS",   "Invalid number of arguments" },
    {  -407, "DB_ESQLININVALIDARGUMENTTYPE",      "Invalid argument type" },
    {  -408, "DB_EINVALIDNUMBER",                 "Invalid number" },
    {  -409, "DB_ESQLINVALIDQUALIFIER",           "Invalid qualifier" },
    {  -410, "DB_ESQLINCOMPATIBLEROWTYPES",       "Incompatible row types" },
    {  -411, "DB_ESQLPARSEERROR",                 "Error parsing SQL syntax" },
    {  -412, "DB_ESQLNOTAGROUPBYEXPRESSION",      "Selected field is not a group-by expression" },
    {  -413, "DB_ESQLFEATURENOTALLOWED",          "Feature not allowed" },
    {  -414, "DB_ESQLDIVIDEBYZERO",               "Divide by zero" },
    {  -415, "DB_ESQLTYPECVTNOTIMPLEMENTED",      "Cannot convert to incompatible type" },
    {  -416, "DB_ESQLOPERATIONNOTIMPLEMENTED",    "Operation not implemented" },
    {  -417, "DB_ESQLINVALIDRELATIONALOPERATOR",  "Invalid relation" },
    {  -418, "DB_ESQLROWSIZETOOLARGE",            "Row size too large" },
    {  -419, "DB_ESQLNOTSORTABLETYPE",            "Ordered by non-sortable type" },
    {  -420, "DB_ESQLNOTENOUGHVALUES",            "Not enough values specified" },
    {  -421, "DB_ESQLTOOMANYVALUES",              "Too many values specified" },
    {  -422, "DB_ESQLBOOLEXPRESSIONINSELECTLIST", "Boolean expression in select list" },
    {  -423, "DB_ESQLENV",                        "SQL environment error" },
    {  -424, "DB_ESQLINCONSISTENTPARAMTYPE",      "Inconsistent parameter type" },
    {  -425, "DB_ESQLCOULDNOTDEDUCEPARAMTYPE",    "Could not deduce parameter type from context" },
    {  -426, "DB_ESQLINVALIDPARAMINDEX",          "Missing parameter value" },
    {  -427, "DB_ESQLPARAMCONVERT",               "Could not convert parameter to required type" },
    {  -428, "DB_ESQLMIXEDPARAMSTYLE",            "Mixed parameter style (? and $) not supported" },
    {  -429, "DB_ESQLINVALIDCOLUMNINDEX",         "Invalid column number" },
    {  -430, "DB_ESQLINVALIDSORTCOLUMN",          "Invalid column number in order by clause" },
    {  -431, "DB_ESQLINVALIDEXPRTYPE",            "Invalid expression type, boolean may be expected" },
    {  -432, "DB_ESQLBINARYLITERAL",              "Invalid BINARY type literal" },
    {  -433, "DB_ESQLINVALIDEXTRACTFIELD",        "Invalid EXTRACT field" },
    {  -499, "DB_ESQLTIMEOUT",                    "Timeout in SQL" },
    {  -500, "DB_EREP_PEERPATH",                  "Path to peer is unknown" },
    {  -501, "DB_EREP_PEERADDRESS",               "Invalid or unset peer address" },
    {  -502, "DB_EREP_ADDRESS",                   "Invalid or unset replication address" },
    {  -503, "DB_EREP_INVADDRESS",                "The replication address of the other database does not match the expected peer address" },
    {  -504, "DB_EREP_LOOPBACK",                  "Attempt to replicate with a database having the same address" },
    {  -505, "DB_EREP_NOPEER",                    "Unknown replication peer" },
    {  -506, "DB_EREP_CONFLICT",                  "Conflict when propagating to replication peer" },
    {  -507, "DB_EREP_NOCONN",                    "Unable to open connection to replication peer" },
    {  -508, "DB_EREP_BUFSIZE",                   "Buffer underflow during replication" },
    {  -509, "DB_EREP_PEERTYPE",                  "Peer type is not valid" },
    {  -510, "DB_EREP_INCONSISTENT",              "Inconsistent replication state, which often indicates that the same replication address was assigned to multiple databases" },
    {  -600, "DB_ESYNC_NODB",                     "No such database" },
    {  -601, "DB_ESYNC_DUPLICATEDB",              "Duplicate databases are not allowed" },
    {  -602, "DB_ESYNC_CONNECT",                  "Unable to connect to the sync database" },
